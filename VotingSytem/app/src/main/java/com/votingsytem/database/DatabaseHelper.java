...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public User_POJO getProfile(String user_id) {
		...
		if (cur != null && cur.moveToFirst()) {
			do {
				...
				profile.password = cur.getString(cur
	...
	public User_POJO getProfileFromEmail(String email_id) {
		...
		String sql = "SELECT * FROM " + DB_REGISTRATION + " WHERE email LIKE '"
				+ email_id + "'";
		Cursor cur = sqliteDatabase.rawQuery(sql, null);
		...
		if (cur != null && cur.moveToFirst()) {
			do {
				...
				profile.password = cur.getString(cur
						.getColumnIndex("password"));
				profile.email = cur.getString(cur
