...
public class RegistrationActivity extends Activity implements OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    SharedPreferences sharedPreferences, sharedPrefUT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefUT = getSharedPreferences("PrefVoting", MODE_PRIVATE);
    ...
    public class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("http://evotingsystem.000webhostapp.com/register.php"); // here is your URL path

                JSONObject postDataParams = new JSONObject();
                postDataParams.put("token", sharedPrefUT.getString("user_token", ""));
